...
export default function ThemeToggle({className}) {
  ...
  return (
    <button
      onClick={toggleTheme}
      className={className+` w-full h-10 p-2 grid bg-neutral-200/25 dark:bg-neutral-700/25 hover:bg-neutral-100/25 dark:hover:bg-neutral-600/25 backdrop-blur text-neutral-600 dark:text-neutral-300 rounded-b-lg rounded-t-2xl transition-all`}
