  ...
  return (
    <Drawer.Root shouldScaleBackground={false}>
      ...
      <Drawer.Portal>
        ...
        <Drawer.Content className={`cursor-pointer bg-neutral-50 dark:bg-neutral-800 flex flex-col items-center pt-12 pb-0 px-4 sm:px-8 gap-6 max-w-5xl mx-auto rounded-t-3xl h-[90%] fixed bottom-0 left-0 right-0 ${contentStyles}`}>
