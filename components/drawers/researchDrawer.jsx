          ...
          <div className="flex flex-wrap gap-3 mt-4 transition-all duration-200">
            {research.URL && (
              <a
                ...
                className="group flex items-center h-12 font-semibold text-teal-700 dark:text-teal-500 transition-all duration-500 px-4 py-3 rounded-full bg-neutral-200/[0.5] dark:bg-neutral-700/[0.5] hover:bg-teal-100 dark:hover:bg-teal-900"
